...
<title>Nurse Medical Records - MHR System</title>
                    ...
                    <?php foreach ($records as $record): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="POST" action="medical_records.php" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this record?');">
